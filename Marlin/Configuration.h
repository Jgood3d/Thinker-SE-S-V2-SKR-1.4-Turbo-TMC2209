...
#define STRING_CONFIG_H_AUTHOR "(SKR 1.4 Turbo Thinker S V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Thinker S V2 SKR 1.4 Turbo"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, 05, 0 }
